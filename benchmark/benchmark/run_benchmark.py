...
DATASET_ALIASES = {
    ...
    "student_performance": "student_performance_dataset",
    "student_performance_dataset": "student_performance_dataset",

    "temp_and_rain": "temp_and_rain_dataset",
    "temp_and_rain_dataset": "temp_and_rain_dataset",
}
    ...
    for dataset_key, meta in DATASETS.items():
        ...
        if not os.path.exists(
            ...
            raise FileNotFoundError(
                f"Dataset file missing for "
                f"{dataset_key}:\n"
                f"{csv_path}"
            )

    print(
        "       [OK] All 6 dataset files found"
    )
...
def main():
    ...
    if (
        ...
        print(
            "[WARNING] Benchmark configuration "
